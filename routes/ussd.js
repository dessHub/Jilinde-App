...
module.exports = {
  ...
  if (text === '') {
     ...
     message += "0: Exit";
		...
		message = 'END Place a report on via one of our platforms (mobile app, website or ussd).On reporting include your mobile No.Jilinde will asign one of its lawyers to your case and we will contact with more details.\n';
	}
	else if (text === '0' || text === '1*0' || text === '2*0') {
